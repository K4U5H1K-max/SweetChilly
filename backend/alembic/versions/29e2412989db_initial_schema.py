...
Revision ID: 29e2412989db
Revises: 
Create Date: 2026-09-21 22:07:32.965636
...
def upgrade() -> None:
    ...
    sa.Column('relevance_reasons', postgresql.JSONB(astext_type=sa.Text()), nullable=True),
    ...
    sa.Column('status', sa.Enum('DETECTED', 'ACTIVE', 'ONGOING', 'RESOLVED', 'EXPIRED', 'PLANNED', 'CANCELLED', name='eventstatus'), nullable=True),
    sa.Column('severity', sa.Enum('CRITICAL', 'HIGH', 'MEDIUM', 'LOW', 'UNKNOWN', name='eventseverity'), nullable=True),
    sa.Column('severity_reasons', postgresql.JSONB(astext_type=sa.Text()), nullable=True),
    sa.Column('transport_modes', postgresql.ARRAY(sa.String()), nullable=True),
    sa.Column('affected_infrastructure', postgresql.ARRAY(sa.String()), nullable=True),
    sa.Column('affected_route', sa.String(), nullable=True),
    sa.Column('direction', sa.String(), nullable=True),
    sa.Column('accessibility_impact', sa.Boolean(), nullable=True),
    sa.Column('accessibility_types', postgresql.ARRAY(sa.String()), nullable=True),
    ...
    op.create_index(op.f('ix_events_accessibility_impact'), 'events', ['accessibility_impact'], unique=False)
    op.create_index(op.f('ix_events_cause'), 'events', ['cause'], unique=False)
    ...
    op.create_index(op.f('ix_raw_documents_canonical_url'), 'raw_documents', ['canonical_url'], unique=False)
    op.create_index(op.f('ix_raw_documents_external_id'), 'raw_documents', ['external_id'], unique=False)
    op.create_index(op.f('ix_raw_documents_original_url'), 'raw_documents', ['original_url'], unique=True)
    op.create_index(op.f('ix_raw_documents_source_id'), 'raw_documents', ['source_id'], unique=False)
    op.create_table('source_runs',
    sa.Column('id', sa.String(), nullable=False),
    sa.Column('source_id', sa.String(), nullable=False),
    sa.Column('status', sa.Enum('RUNNING', 'SUCCESS', 'FAILED', name='runstatus'), nullable=True),
    sa.Column('started_at', sa.DateTime(timezone=True), server_default=sa.text('now()'), nullable=True),
    sa.Column('finished_at', sa.DateTime(timezone=True), nullable=True),
    sa.Column('documents_fetched', sa.Integer(), nullable=True),
    sa.Column('documents_inserted', sa.Integer(), nullable=True),
    sa.Column('documents_rejected', sa.Integer(), nullable=True),
    ...
    sa.Column('reliability', sa.Enum('OFFICIAL_GOVERNMENT', 'OFFICIAL_TRANSPORT_OPERATOR', 'OFFICIAL_WEATHER', 'ESTABLISHED_NEWS', 'AGGREGATOR', 'OTHER', name='sourcereliability'), nullable=True),
    sa.Column('health_status', sa.Enum('HEALTHY', 'DEGRADED', 'FAILED', 'UNKNOWN', name='sourcehealthstatus'), nullable=True),
    ...
    op.create_table('accessibility_impacts',
    sa.Column('id', sa.String(), nullable=False),
    sa.Column('event_id', sa.String(), nullable=False),
    sa.Column('accessibility_type', sa.String(), nullable=True),
    ...
    op.create_index(op.f('ix_accessibility_impacts_accessibility_type'), 'accessibility_impacts', ['accessibility_type'], unique=False)
    op.create_index(op.f('ix_accessibility_impacts_event_id'), 'accessibility_impacts', ['event_id'], unique=False)
    ...
    op.create_index(op.f('ix_document_locations_document_id'), 'document_locations', ['document_id'], unique=False)
    op.create_index(op.f('ix_document_locations_location_id'), 'document_locations', ['location_id'], unique=False)
    ...
    op.create_index(op.f('ix_event_impacts_impact_type'), 'event_impacts', ['impact_type'], unique=False)
    ...
    op.create_index(op.f('ix_event_locations_event_id'), 'event_locations', ['event_id'], unique=False)
    op.create_index(op.f('ix_event_locations_location_id'), 'event_locations', ['location_id'], unique=False)
    ...
    op.create_index(op.f('ix_event_sources_document_id'), 'event_sources', ['document_id'], unique=False)
    op.create_index(op.f('ix_event_sources_event_id'), 'event_sources', ['event_id'], unique=False)
    op.create_table('event_updates',
    sa.Column('id', sa.String(), nullable=False),
    sa.Column('event_id', sa.String(), nullable=False),
    sa.Column('document_id', sa.String(), nullable=True),
    sa.Column('previous_status', sa.Enum('DETECTED', 'ACTIVE', 'ONGOING', 'RESOLVED', 'EXPIRED', 'PLANNED', 'CANCELLED', name='eventstatus'), nullable=True),
    sa.Column('new_status', sa.Enum('DETECTED', 'ACTIVE', 'ONGOING', 'RESOLVED', 'EXPIRED', 'PLANNED', 'CANCELLED', name='eventstatus'), nullable=True),
    ...
    op.create_index(op.f('ix_event_updates_document_id'), 'event_updates', ['document_id'], unique=False)
    op.create_index(op.f('ix_event_updates_event_id'), 'event_updates', ['event_id'], unique=False)
    # Removed errant postgis drops
...
def downgrade() -> None:
    ...
    op.drop_index(op.f('ix_event_updates_event_id'), table_name='event_updates')
    op.drop_index(op.f('ix_event_updates_document_id'), table_name='event_updates')
    op.drop_table('event_updates')
    op.drop_index(op.f('ix_event_sources_event_id'), table_name='event_sources')
    op.drop_index(op.f('ix_event_sources_document_id'), table_name='event_sources')
    op.drop_table('event_sources')
    op.drop_index(op.f('ix_event_locations_location_id'), table_name='event_locations')
    op.drop_index(op.f('ix_event_locations_event_id'), table_name='event_locations')
    op.drop_table('event_locations')
    op.drop_index(op.f('ix_event_impacts_impact_type'), table_name='event_impacts')
    op.drop_index(op.f('ix_event_impacts_event_id'), table_name='event_impacts')
    op.drop_table('event_impacts')
    op.drop_index(op.f('ix_document_locations_location_id'), table_name='document_locations')
    op.drop_index(op.f('ix_document_locations_document_id'), table_name='document_locations')
    op.drop_table('document_locations')
    op.drop_index(op.f('ix_accessibility_impacts_event_id'), table_name='accessibility_impacts')
    op.drop_index(op.f('ix_accessibility_impacts_accessibility_type'), table_name='accessibility_impacts')
    op.drop_table('accessibility_impacts')
    ...
    op.drop_index(op.f('ix_raw_documents_original_url'), table_name='raw_documents')
    op.drop_index(op.f('ix_raw_documents_external_id'), table_name='raw_documents')
    op.drop_index(op.f('ix_raw_documents_canonical_url'), table_name='raw_documents')
    ...
    op.drop_index(op.f('ix_events_cause'), table_name='events')
    op.drop_index(op.f('ix_events_accessibility_impact'), table_name='events')
