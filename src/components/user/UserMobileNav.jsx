...
/**
 * Mobile Bottom Navigation Bar for User Portal
 * Switches between dedicated application screens (Home | Map | Deployments | Vehicles | More)
 * No stacked scrollIntoView pseudo-navigation.
 */
export default function UserMobileNav({
  ...
  const tabs = [
    ...
    },
    {
      ...
      icon: <IconDeployments className="w-5 h-5" />,
    },
    {
      id: 'VEHICLES',
      label: 'Vehicles',
