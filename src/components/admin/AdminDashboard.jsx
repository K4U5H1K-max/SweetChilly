            ...
            <div className="max-w-7xl mx-auto flex flex-col gap-6">
              ...
              <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 items-end">
                ...
                <div className="lg:col-span-5 flex flex-wrap items-center justify-start lg:justify-end gap-2.5">
                  ...
                  {/* Primary Deploy Vehicle CTA */}
                  <button
                    onClick={() => handleOpenDeployModal(null)}
                    className="px-4 py-2.5 bg-blue-700 hover:bg-blue-800 text-white font-bold text-xs rounded-lg transition-all shadow-xs flex items-center gap-1.5 cursor-pointer"
                  >
                    <span>⚡</span>
                  ...
                  <button
                    ...
                    className="px-3.5 py-2.5 bg-slate-900 hover:bg-slate-800 text-white font-semibold text-xs rounded-lg transition-all shadow-xs flex items-center gap-1.5 cursor-pointer"
                  >
